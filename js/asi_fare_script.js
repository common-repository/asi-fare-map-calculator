            ...
            for (var i = 0; i < origins.length; i++) {
                ...
                for (var j = 0; j < results.length; j++) {
                    ...
                    */
                    ...
                    //jQuery("#po").append("<span class='nearest'>Distance in miles: " + jQuery("#distance").val() + "</span><br>");
                    //jQuery("#po").append("<span class='nearest'>Distance in km: " + distanceinkm + " km </span><br>");
